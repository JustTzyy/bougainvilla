...
class StayController extends Controller
{
    ...
    public function archived(Request $request)
    {
        try {
            ...
            // Get archived stays with all related data including receipts and users
    ...
    public function reports(Request $request)
    {
        try {
            ...
            $checkinsRange = Stay::whereBetween('checkIn', [$fromCarbon, $toCarbon])->count();
            $checkoutsRange = Stay::whereBetween('checkOut', [$fromCarbon, $toCarbon])->count();

            // Revenue shortcuts
            // Guests involved within date range (unique guest-stay rows for stays that started in range)
            $guestsRange = GuestStay::whereIn('stayID', Stay::whereBetween('checkIn', [$fromCarbon, $toCarbon])->pluck('id'))
                ->count();
            ...
            $guestsInRange = GuestStay::whereIn('stayID', Stay::whereBetween('checkIn', [$fromCarbon, $toCarbon])->pluck('id'))->count();
            $guestsTotal = Guest::withTrashed()->count();
            $activeStayIds = Stay::where('status', 'Active')->pluck('id');
