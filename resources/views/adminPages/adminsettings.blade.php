            ...
            <div class="address-section">
              <div class="form-row">
                <div class="form-group">
                  ...
                  <input type="text" class="form-input @error('street') error-highlight @enderror" name="street" value="{{ old('street', Auth::user()->address->street ?? '') }}" required>
                  @error('street')
                    <div class="error-message">{{ $message }}</div>
                  @enderror
                </div>
              ...
              <div class="form-row">
                <div class="form-group">
                  ...
                  <select name="province" class="form-input @error('province') error-highlight @enderror" required>
                ...
                <div class="form-group">
                  ...
                  <select name="city" class="form-input @error('city') error-highlight @enderror" required>
        ...
        <div class="chart-card">
          ...
          <form method="POST" action="{{ route('adminPages.settings.deactivate') }}" onsubmit="return confirmDeactivation()">
            ...
            <div class="form-group">
              ...
              <input type="password" id="deactivate_password" name="password" class="@error('password') error-highlight @enderror" required>
