    ...
    <div class="user-details-content" style="padding: 12px; background: linear-gradient(135deg, #f8f9ff 0%, #ffffff 100%);">
      ...
      <div class="user-info-section" style="background: linear-gradient(135deg, #ffffff 0%, #f8f9ff 100%); border-radius: 12px; padding: 12px; margin-bottom: 12px; box-shadow: 0 2px 12px rgba(138,92,246,.08); border: 1px solid rgba(138,92,246,.1);">
        ...
        <div class="info-grid" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 16px;">
          <div class="info-item" style="background: rgba(138,92,246,.05); padding: 12px; border-radius: 10px; border-left: 4px solid var(--purple-primary); transition: all 0.3s ease;">
            ...
            data.rooms.forEach(function(room) {
              ...
              if (room.type || (room.accommodations && room.accommodations.length > 0)) {
                ...
                if (room.accommodations && room.accommodations.length > 0) {
                  ...
                  roomsHtml += '<span style="display: inline-flex; align-items: center; gap: 3px; padding: 2px 6px; background: rgba(138,92,246,.05); border-radius: 6px; border-left: 2px solid var(--purple-primary); font-size: 9px; color: #6c757d; font-weight: 600;"><i class="fas fa-bed" style="color: var(--purple-primary); font-size: 8px;"></i>' + accommodationNames + '</span>';
                }
                roomsHtml += '</div>';
              }
