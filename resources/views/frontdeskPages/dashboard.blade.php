...
<div class="dashboard-page">
  ...
  <div class="chart-card card-tight">
    ...
    <div id="summary" class="summary-grid">
      <div class="summary-card clickable-card" data-route="{{ route('frontdesk.transactionreports') }}">
...
(function(){
  ...
  async function load(){
    ...
    const res = await fetch('/frontdesk/dashboard?from='+from+'&to='+to, { headers: { 'Accept': 'application/json' }});
